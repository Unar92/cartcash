    ...
    <DashboardLayout>
      {loading ? (
        ...
        <div className="space-y-6">
          <div>
            <h1 className="text-2xl font-semibold text-gray-900 dark:text-white">Abandoned Carts</h1>
            <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">
              Manage and recover your abandoned carts here. View detailed information and export data for analysis.
            </p>
          </div>
                ...
                <div className="flex items-center">
                  ...
                  <div className="ml-5 w-0 flex-1">
                    <dl>
                      ...
                      <dd className="mt-1 text-3xl font-semibold text-gray-900 dark:text-white">
                        {carts.length > 0 ? ((carts.filter(cart => cart.completed_at).length / carts.length) * 100).toFixed(1) : '0.0'}%
                      </dd>
                    </dl>
                  </div>
                </div>
